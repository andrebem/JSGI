...
public class Matriz {
	...
	public static Matriz translacao2d(double dx, double dy){
	...
	public static Matriz escalonamento2d(double sx, double sy) {
	...
	public static Matriz rotacao2d(double angulo) {
	...
	public static Matriz translacao3d(double dx, double dy, double dz){
		//TODO!
		return null;
	}
	
	public static Matriz escalonamento3d(double sx, double sy, double sz) {
		//TODO!
		return null;
	}	
	
	public static Matriz rotacao3d(double angulo) {
		//TODO! essa matriz deve fazer a rotação ao redor do eixo Z somente.
		return null;
	}	
